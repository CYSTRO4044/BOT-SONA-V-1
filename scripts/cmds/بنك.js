...
config: {
    ...
    description: {
      ...
      en: "بنك تسجيل ، سحب ، إيداع ، تحويل..."
    },
    longDescription: "بنك البوت",
    category: "العاب",
    guide: {
      vi: '',
      en: "{pn}"
  ...
  langs: {
    en: {
      ...
      transfer_Dm: "═══𝗧𝗿𝗮𝗻𝘀𝗳𝗲𝗿═════\n• الإسم: %3\n• المعرف: %1\n• مبلغ البنك المحول لك: %7 دولار\n•كم كان معك سابقا: %6 دولار\n•إسم حسابك في البنك: %4\n• معرفك: %2\n• كم كان مع الذي حول لك: %5 دولار\n════════════════",
  ...
  onStart: async function({ usersData, threadsData, event, args, message, getLang, api }) {

      const services = "⓵. تسجيل\n⓶. إيداع\n⓷. عرض\n⓸. سحب\n⓹. قرض\n⓺. سدالقرض\n⓻. تحويل\n═════════𝗕𝗮𝗻𝗸═════════\n• الفائدة تلقائية: => 10 رسائل تحصل على فائدة 50 Da 🙆‍♂️🤍\n❗ فقط لمن سجل في البنك";
    ...
    onChat: async function({ getLang, usersData, message, event }) {
